...
$(document).ready(function () {
    ...
    !function (s) {
        ...
        }(), s(".site-header .navigation").length && (o = s(".site-header .navigation"), r = "sticky-header", o.addClass("original").clone().insertAfter(o).addClass(r).removeClass("original")), s("#clock").length && s("#clock").countdown("2021/07/29 19:00:00", function (e) {
